  ...
  return (
    <div className="bg-white py-6 sm:py-8 lg:py-12">
      <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
        <h2 className="mb-4 text-center text-2xl font-bold text-gray-800 md:mb-8 lg:text-3xl">新規登録</h2>
        ...
        <form className="mx-auto max-w-lg rounded-lg border">
          ...
          <div className="flex items-center justify-center bg-gray-100 p-4">
            <p className="text-center text-sm text-gray-500">
              アカウントがある方はこちら<Link href={"/login"} className="text-indigo-500 transition duration-100 hover:text-indigo-600 active:text-indigo-700">ログイン</Link>
            </p>
          </div>
        </form>
      </div>
